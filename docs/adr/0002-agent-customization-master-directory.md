...
| .codex/skills | .agents/skills | 今は .codex ではなく .agents で良い |
| .github/skills | .agents/skills |  |
| .claude/skills | .agents/skills |  |
| .github/agents/<agent-name>.agent.md | .agents/subagents/<agent-name>.md | ファイル名も変える |
...
- 更新日: 2026-07-12
- 置き換え先 ADR: なし
- 更新理由: Codex が リポジトリの `.agents/skills/` を標準で探索する仕様が確認できたため skills のツール固有リンク方針を見直した
